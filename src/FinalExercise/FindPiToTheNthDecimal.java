...
public class FindPiToTheNthDecimal {
    ...
    public static void main(String[] args) {
        System.out.println(FindPiToNthDigit(4000));
    }
    ...
    public static BigDecimal FindPiToNthDigit(int NDecimals){
        ...
        BigDecimal cPrecise = C.multiply(BigDecimalHelper.GetPreciseSqrt(10005, NDecimals));
        ...
        return piValue.setScale(NDecimals, BigDecimal.ROUND_DOWN);
    }
